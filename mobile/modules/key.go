...
func NewOpenPGPKey() *OpenPGPKey {
	return &OpenPGPKey{}
}

func (o *OpenPGPKey) ReadSignKey(publicKey, privateKey, passphrase string) (*openpgp.Entity, error) {
...
func (o *OpenPGPKey) ReadPrivateKey(key, passphrase string) (openpgp.EntityList, error) {
...
func (o *OpenPGPKey) ReadPublicKey(key string) (openpgp.EntityList, error) {
...
func (o *OpenPGPKey) ReadSignature(message string) (*packet.Signature, error) {
...
func (o *OpenPGPKey) Decrypt(message, privateKey, passphrase string) (string, error) {
...
func (o *OpenPGPKey) Encrypt(message, publicKey string) (string, error) {
...
func (o *OpenPGPKey) Sign(message, publicKey, privateKey, passphrase string) (string, error) {
...
func (o *OpenPGPKey) Verify(signature, message, publicKey string) (bool, error) {
	entityList, err := o.ReadPublicKey(publicKey)
	if err != nil {
		return false, err
	}
